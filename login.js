      ...
      <ImageBackground source={{uri:'http://img.chuing.net/i/pNeVVN/Preview.x.jpg'}} style={styles.backgroundContainer}>
        <KeyboardAvoidingView behavior="padding" style={styles.container}>
          ...
          <View style={styles.title}>
            <Text style={{fontSize:35,paddingBottom:20,fontWeight:'700',color:'white'}}>DOICE</Text>           
          </View>
          <View style={{justifyContent:'center',alignItems:'center',paddingBottom:10}}>
              <Text style={{fontSize:15,color:'white',paddingBottom:20}}>세상의 모든 결정장애를 위한 플랫폼</Text>          
          </View>
